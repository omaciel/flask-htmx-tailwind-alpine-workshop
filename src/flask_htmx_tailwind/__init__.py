...
feeds = {
    ...
    "https://omaciel.github.io/index.xml": {"title": "Og Maciel", "href": "https://omaciel.github.io/index.xml", "show_images": False, "entries": {}},
    "https://techcrunch.com/feed": {"title": "Tech Crunch", "href": "https://techcrunch.com/feed", "show_images": False, "entries": {}}
}
def create_app():
    app = Flask(__name__)
    ...
    @app.route("/<path:feed_url>/entry/<path:entry_url>")
